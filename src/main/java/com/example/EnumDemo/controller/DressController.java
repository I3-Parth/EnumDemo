...
public class DressController {
    ...
    @GetMapping("/find")
    public List<DressDisplayDto> getDressesByBrands(@RequestParam(name = "brand", required = false)String[] brands, @RequestParam(name = "size", required = false)Size size, @RequestParam(name = "type", required = false)DressType type, @RequestParam(name = "color", required = false)Color color, @RequestParam(name = "price", required = false)Long price){
